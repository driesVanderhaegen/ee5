...
public class PacketMotionData extends Packet {
	...
	public String toJSON() {
		...
		//String json = ""+getFrontWheelsAngle()+"\n\n\n";
		F12018TelemetryUDPServer.setvalue(getFrontWheelsAngle());

		String json = "\nWorldPositionX = " + getCarMotionDataList().get(getHeader().getPlayerCarIndex()).getWorldPositionX()
				+ "\nWorldPositionY = " + getCarMotionDataList().get(getHeader().getPlayerCarIndex()).getWorldPositionY()
				+ "\nWorldPositionZ = " + getCarMotionDataList().get(getHeader().getPlayerCarIndex()).getWorldPositionZ()
				+ "\nFrontWheelAngle = " + getFrontWheelsAngle();
