...
public class PacketSessionData extends Packet {
	...
	public PacketSessionData() {/*
		System.out.println("driverStats: airTemp " + getAirTemperature());
		System.out.println("Race: totalLaps " + getTotalLaps());
		System.out.println("Race: sessionType " + getSessionType());
		System.out.println("Race: trackID " + getTrackId());
		System.out.println("driverstats: weather " + getWeather());*/
	}

	public String toJSON() {

		String json = "\nWeather = " +  getWeather()
				+ "\nTrackTemperature = " + getTrackTemperature()
	...
	public void display() {
		...
		String[] circuits = {"Melbourne","PaulRicard","Shanghai","Sakhir","Catalunya","Monaco","Montreal","Silverstone"
				,"Hockenheim","Hungaroring","Spa","Monza","Singapore","Suzuku","Abu","Texas","Brazil","Austria","Sochi"
				,"Mexico","Baku","SakhirS","SilverstoneS","TexasS","SuzukaS"};
		int tID = getTrackId();
		String cr = circuits[tID];
		int totallaps = getTotalLaps();
		String sessiontype = "" + getSessionType();
		System.out.println("Race: totalLaps " + totallaps);
		System.out.println("Race: sessionType " + sessiontype);
		System.out.println("Race: trackID " + cr + "length:" + circuits.length);
		F12018TelemetryUDPServer.getDatabase().setSessionData(totallaps,sessiontype,cr);
